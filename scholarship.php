  ...
  <div class="content">
   	...
   	<form method="post" action="adm_code.php">
                ...
                <tr>
                    ...
                    <th class="bold th">Total Marks</th>
                    <th class="bold th">Scholarship</th>
                </tr>
                
                <?php
			//	$result=mysql_query("SELECT a.aca_id,a.aca_marksobtained,a.aca_totalmarks,s.st_name,s.st_fname FROM student_admission as s inner JOIN academics as a ON s.st_id=a.st_id where s.st_id=a.st_id and a.aca_marksobtained>=a.aca_totalmarks*(80/100)");
				//$result=mysql_query("SELECT * from student_admission");
			     $result=mysqli_query($conn,"SELECT a.aca_id,a.aca_marksobtained,a.aca_totalmarks,s.st_name,s.st_fname FROM student_admission as s inner JOIN studunt_academic as a ON s.st_id=a.st_id where s.st_id=a.st_id and a.aca_marksobtained>=a.aca_totalmarks*(80/100)");
...
//				{
				...
				echo '<td>'.$j.'</td>';
				  ...
				  if($test['aca_marksobtained']>=$test['aca_totalmarks']*(90/100)) 
				   {
				   echo '<td>10,000</td>';
				   }
				   else
