...
<div class="wrapper"> 
  ...
  <div class="content">
    ...
    <p class="para"> <a href="result_by_name.php" class="roll" title="Search By Student's Name">Search By Name</a>
    <form method="post">
      <fieldset style="width:50%;margin:30px 50px auto 200px;">
        <table >
          <tr>
            <td>Roll No:</td>
            <td><input type="text" name="rol" title="Enter Name" /></td>
          </tr>
          <tr>
            <td></td>
      ...
      <?php
                		if(isset($_POST['search']))
						{
							...
							$result=mysql_query("SELECT a.aca_roll,a.aca_marksobtained,a.aca_totalmarks,ad.aid, ad.st_name,ad.st_id FROM  studunt_academic as a inner join student_admission as ad ON a.st_id=ad.st_id where a.st_id=ad.st_id AND a.aca_roll='".$_POST['rol']."'");
							...
							{
								echo '<strong style="text-align:center;">Invalid Roll No!</strong>';
							}
