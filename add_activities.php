...
<br style="clear:both;" />
  ...
  <!--slide bar-->
    ...
    <div class="content">
        ...
        <h4 class="bold">Add Activities:</h4>
         <p class="para">
         	<form method="post">
                ...
                if(isset($_REQUEST['acid']))
				{
					 $result=mysql_query("SELECT * FROM activities where aid='".$_REQUEST['acid']."'");
                ...
                <tr>
                <td>Name:</td>
            <td><input type="text" name="name" title="Activity Name" value="<?php if(isset($_REQUEST['acid'])) { echo $test3['aname'];} ?>" /></td>
          </tr>
          <tr>
            <td>Detail:</td>
            <td><textarea name="description"  title="Detail of Activity" ><?php if(isset($_REQUEST['acid'])) { echo $test3['adetails'];} ?></textarea></td>
          </tr>
          
          <tr>
           <td colspan="2" align="center">
           <?php if(isset($_REQUEST['acid'])) { 
		   ?>
           <input type="submit" name="upd" value="Update" class="btn" title="Add New Activity" />
           <?php 
		   }
		   else
		   {
		   ?>
            ...
            <input type="submit" name="act" value="Submit" class="btn" title="Add New Activity" />
           <?php
		   }
		   ?>
            </td>
			  ...
			  if(isset($_POST['upd']))
				{
					...
					mysql_query("update activities set aname='".$_POST['name']."',adetails='".$_POST['description']."' where aid='".$_REQUEST['acid']."'");
              ...
              if(isset($_POST['act']))
				{
					...
					mysql_query("insert into activities(aname,adetails) values('".$_POST['name']."','".$_POST['description']."')");
