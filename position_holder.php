...
<br style="clear:both;" />
  ...
  <!--slide bar-->
    ...
    <div class="content">
        ...
        <h4 class="bold">Position Holders:</h4>
         <p class="para">
   			 <?php
					
					
				$albums=mysqli_query($conn,"select * from  albumpics where albumid=4");
				if(mysqli_num_rows($albums)<1)
				{
					echo "<strong>There is no pictures available for Toppers!</strong>";
				}
				...
				while($pic=mysqli_fetch_array($albums))
				{
					$id=$pic['picid'];
					$aid=$pic['albumid'];
					echo '<div  style="float:left;height:150px; width:180px;padding-left:10px;border:1px #000 solid;margin-left:5px;margin-bottom:5px;border-radius:5px;text-align:center;">';
					echo '<div>			
					<img src="images/'.$pic['pic'].'" style="height:100px;width:100px;margin-top:20px;"/>
