  ...
  <!--slide bar-->
    ...
    <div class="content">
        ...
        <h4 class="bold">SEARCH RESULT:</h4>
         <p class="para" style="height:300px;">
         <a href="result_by_name.php" class="roll" title="Search By Student's Name" style="float:left">Search By Name</a><br /><br />


         <a href="result_by_roll.php" class="roll" title="Search By Student's Roll No" style="float:left">Search By Roll No</a>
        <br />
